...
var
	...
	bandwidth_down = 160000,	// in bps
	bandwidth_up   = 160000,	// in bps
	latency        = 400;		// in ms
...
function showResult(){
    for(var log_key in time_logs){
        ...
        console.log(log_key+" = "+temp_sort[4]);
    }
    time_logs = [];
}
